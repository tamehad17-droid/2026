...
-- 6. Create or update update_wallet_balance function
...
BEGIN
    ...
    IF p_type = 'add' THEN
        ...
        SET 
            ...
            earnings_from_bonuses = CASE WHEN p_category = 'bonus' THEN earnings_from_bonuses + p_amount ELSE earnings_from_bonuses END,
            updated_at = NOW()
        WHERE user_id = p_user_id;
...
-- 7. Create or update the reject_user function
